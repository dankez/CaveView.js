export const en = {
  ...
  measuring: {
    ...
    endPoint: "End point",
    selection: "Selection",
    tectonicsTitle: "Tectonic Measurement (3 points)",
    dip: "Dip angle",
    dipDirection: "Dip direction",
    strike: "Strike (Intersection)",
    normalVector: "Plane normal",
    triangleArea: "Plane area",
    perimeter: "Perimeter",
    strikeLine: "Strike line (H-plane)",
    dipLine: "Dip line",
    point3: "Point 3",
