export const sk = {
  ...
  welcome: {
    ...
    dzSub: "Podporované: .lox, .3d, .plt, .ply, .stl, .tif",
  ...
  measuring: {
    ...
    selection: "Výber",
    tectonicsTitle: "Tektonické meranie (3 body)",
    dip: "Sklon po spádnici",
    dipDirection: "Azimut spádnice",
    strike: "Smer vrstvy (Priesečník)",
    normalVector: "Normála plochy",
    triangleArea: "Plocha roviny",
    perimeter: "Obvod",
    strikeLine: "Priesečník s H-rovinou",
    dipLine: "Spádnica",
    point3: "3. Bod",
