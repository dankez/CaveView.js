# Graph Report - CaveView-modernized  (2026-06-04)

## Corpus Check
- 244 files · ~296,500 words
...
Cohesion: 0.05
Nodes (18): _getId(), BarGeometry, ScaleBar, EditPage, ExportPage, Frame, HelpPage, InfoPage (+10 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (8): ColourCache, SurveyColourMapper(), ExportGltf, StationMarkers, Survey, buildCrossSections(), buildScraps(), buildWallsSync()
...
Cohesion: 0.04
Nodes (23): getBrowserLanguage(), getTranslation(), App(), AppState, CaveViewer3D, CaveViewerNextGen, draw(), encodeState() (+15 more)
...
Cohesion: 0.06
Nodes (8): StationPosition, TextureLookup, unpackRGBA(), LinearScale, Scale, StationLabels, Stations, testPoint()

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (7): Leg, PublicFactory, Segment, Station, CanvasPopup, SegmentPopup, StationPopup

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (41): [1.2.0] - 2026-05-01, [1.3.0] - 2026-05-03, [2.0.1] - 2026-05-17, [2.0.2] - 2026-05-17, [2.1.0] - 2026-06-01, [2.2.0] - 2026-06-01, Branding & Signature (v1.4.3), Changelog (+33 more)
...
Cohesion: 0.08
Nodes (7): Compass, HudObject, EntrancePointMaterial, Materials(), WallMaterial, StationDistancePopup, Grid

### Community 15 - "Community 15"
Cohesion: 0.09
Nodes (25): CalibrationPoint, Props, parseStl(), filePath, parsed, CaveViewerNextGenProps, Lrud, ParsedCave (+17 more)

### Community 16 - "Community 16"
Cohesion: 0.14
Nodes (25): bbox, bounds, dtm, nativeBounds, bbox, calibration, CaveSurface, bboxToString() (+17 more)

### Community 17 - "Community 17"
Cohesion: 0.14
Nodes (23): buildResult(), Calibration, CaveSurface, classifyLiDAR(), normalizePlyColor(), normalizePlyIntensity(), ParsedCave, parseLox() (+15 more)

### Community 18 - "Community 18"
Cohesion: 0.09
Nodes (7): Cfg, DepthMaterial, HeightMaterial, LoxTile, OrbitControls, Segments, Selection
...
Cohesion: 0.11
Nodes (5): PointerControls, CaveViewer, Entrances, LightingManager(), ViewState
...
Cohesion: 0.12
Nodes (18): applyScrapCombinedShader(), applyScrapSelectiveViewShader(), applyScrapWallDepthShader(), applyTaubinSmoothing(), buildScrapsGeo(), CAVE_MATERIAL_PRESETS, CaveMaterialPreset, CaveTexturePreset (+10 more)

### Community 24 - "Community 24"
Cohesion: 0.13
Nodes (3): dataURL(), replaceExtension(), WebTerrain
...
Cohesion: 0.13
Nodes (5): SurveyBox, DistanceFieldPass, HUD(), AnaglyphEffect(), CameraManager()
...
Cohesion: 0.4
Nodes (4): parseGeoTiff(), handleTiffFile(), parseGeoTiffLazy(), Calibration
...
- **Why does `reconstructSurface()` connect `Community 51` to `Community 8`, `Community 0`, `Community 18`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `parsePly()` connect `Community 17` to `Community 18`, `Community 21`, `Community 5`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `intersectTrianglePlane()` connect `Community 8` to `Community 18`?**
