...
## Corpus Check
- 215 files · ~270,694 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1226 nodes · 1975 edges · 129 communities (62 shown, 67 thin omitted)
- Extraction: 69% EXTRACTED · 31% INFERRED · 0% AMBIGUOUS · INFERRED: 605 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2eb4887c`
...
Cohesion: 0.06
Nodes (15): _getId(), EditPage, ExportPage, Frame, HelpPage, InfoPage, Page, Panel (+7 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (23): equalArray(), getCanvas(), getMinMax(), getPaddedArrayBuffer(), getPaddedBufferSize(), GLTFExporter, GLTFLightExtension, GLTFMaterialsClearcoatExtension (+15 more)
...
Cohesion: 0.05
Nodes (22): applyTaubinSmoothing(), buildScrapsGeo(), buildTerrainTileData(), CaveScraps, CaveTraverse, CLASSIFICATION_COLORS, ClippingEdges, computeAngleWeightedNormals() (+14 more)
...
Cohesion: 0.06
Nodes (7): StationPosition, LinearScale, Scale, OrbitControls, StationLabels, Stations, testPoint()
...
Cohesion: 0.2
Nodes (3): Leg, SegmentPopup, CameraManager()
...
## Knowledge Gaps
- **102 isolated node(s):** `AppState`, `LoadedFile`, `SUPPORTED`, `MemoizedStatusBadge`, `Scrap` (+97 more)
...
- **Why does `reconstructSurface()` connect `Community 1` to `Community 0`, `Community 4`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `Survey` connect `Community 25` to `Community 2`, `Community 38`, `Community 7`, `Community 74`, `Community 11`, `Community 14`, `Community 19`, `Community 20`, `Community 55`, `Community 24`, `Community 56`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `Materials()` connect `Community 14` to `Community 0`, `Community 1`, `Community 2`, `Community 6`, `Community 44`, `Community 19`, `Community 27`?**
