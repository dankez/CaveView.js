...
## Corpus Check
- 216 files · ~271,270 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1255 nodes · 2015 edges · 121 communities (58 shown, 63 thin omitted)
- Extraction: 70% EXTRACTED · 30% INFERRED · 0% AMBIGUOUS · INFERRED: 605 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a6dadfaa`
...
## Communities (121 total, 63 thin omitted)
...
Cohesion: 0.07
Nodes (6): ExportGltf, StationMarkers, Survey, buildCrossSections(), buildScraps(), buildWallsSync()

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (9): LineSegments2, LineSegmentsGeometry, SurveyBox, CGeometry, Orb, TerrainMeshGeometry, DyeTraces, Legs (+1 more)
...
Cohesion: 0.05
Nodes (23): applyTaubinSmoothing(), buildScrapsGeo(), buildTerrainTileData(), CaveScraps, CaveTraverse, CLASSIFICATION_COLORS, ClippingEdges, computeAngleWeightedNormals() (+15 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (16): getBrowserLanguage(), getTranslation(), parseGeoTiff(), App(), AppState, encodeState(), execManualMeasure(), findStationByName() (+8 more)
...
Cohesion: 0.13
Nodes (9): Compass, applyLaplacianSmoothing(), applyTaubinSmoothing(), computeAngleWeightedNormals(), reconstructSurface(), reconstructSurfaceNet(), CameraMove, Grid (+1 more)
...
Cohesion: 0.12
Nodes (4): DistanceFieldFilterPass, HUD(), AnaglyphEffect(), CaveViewer
...
## Knowledge Gaps
- **121 isolated node(s):** `AppState`, `LoadedFile`, `SUPPORTED`, `MemoizedStatusBadge`, `Scrap` (+116 more)
...
- **Why does `reconstructSurface()` connect `Community 12` to `Community 0`, `Community 6`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `Materials()` connect `Community 11` to `Community 0`, `Community 33`, `Community 4`, `Community 41`, `Community 12`, `Community 14`, `Community 25`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `Survey` connect `Community 1` to `Community 2`, `Community 4`, `Community 5`, `Community 12`, `Community 50`?**
