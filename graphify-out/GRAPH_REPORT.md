...
## Corpus Check
- 216 files · ~271,588 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1232 nodes · 1983 edges · 125 communities (66 shown, 59 thin omitted)
- Extraction: 69% EXTRACTED · 31% INFERRED · 0% AMBIGUOUS · INFERRED: 605 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2d548c1f`
...
## Communities (125 total, 59 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (16): _getId(), EditPage, ExportPage, Frame, HelpPage, InfoPage, Page, Panel (+8 more)
...
Cohesion: 0.06
Nodes (6): ViewerOptions, AppState, LoadedFile, MemoizedStatusBadge, SelStation, SUPPORTED
...
Cohesion: 0.11
Nodes (6): Cfg, HeightMaterial, Materials(), WallMaterial, OrbitControls, Segments
...
Cohesion: 0.16
Nodes (3): draw(), Entrances, ViewState
...
Cohesion: 0.18
Nodes (3): PointerControls, CaveViewer, Selection
...
Cohesion: 0.38
Nodes (4): downloadTiledXyz(), lat2tile(), lon2tile(), Progress
...
## Knowledge Gaps
- **104 isolated node(s):** `AppState`, `LoadedFile`, `SUPPORTED`, `MemoizedStatusBadge`, `Scrap` (+99 more)
...
- **Why does `Survey` connect `Community 1` to `Community 32`, `Community 3`, `Community 36`, `Community 7`, `Community 23`, `Community 31`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `reconstructSurface()` connect `Community 44` to `Community 8`, `Community 0`, `Community 11`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `Materials()` connect `Community 11` to `Community 0`, `Community 3`, `Community 15`, `Community 17`, `Community 18`, `Community 26`?**
