# Graph Report - CaveView-modernized  (2026-06-05)

## Corpus Check
- 244 files · ~296,998 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1654 nodes · 2827 edges · 152 communities (75 shown, 77 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 606 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `10defcb7`
...
5. `WebTerrain` - 18 edges
6. `Stations` - 18 edges
7. `Legs` - 17 edges
8. `🚀 Latest Features` - 17 edges
9. `🚀 Najnovšie funkcie` - 17 edges
10. `CommonTerrain` - 16 edges
...
Cohesion: 0.07
Nodes (5): StationMarkers, Survey, buildCrossSections(), buildScraps(), buildWallsSync()

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (45): cache, context, element, originalCreateElement, plan, progress, requestedUrls, updates (+37 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (48): applyTaubinSmoothing(), AutoFit(), BoundingBox(), buildSampleIndexes(), buildScrapsGeo(), buildTerrainGeo(), buildTerrainTileData(), CameraMonitor() (+40 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (21): AppState, CaveViewer3D, CaveViewerNextGen, draw(), encodeState(), execManualMeasure(), findStationByName(), formatBytes() (+13 more)
...
Cohesion: 0.05
Nodes (45): [1.2.0] - 2026-05-01, [1.3.0] - 2026-05-03, [2.0.1] - 2026-05-17, [2.0.2] - 2026-05-17, [2.1.0] - 2026-06-01, [2.2.0] - 2026-06-01, [2.3.0] - 2026-06-05, Branding & Signature (v1.4.3) (+37 more)
...
Cohesion: 0.11
Nodes (23): ChunkData, PointCloudLOD(), parseStl(), filePath, parsed, LiDARWorkerMessage, Lrud, ParsedCave (+15 more)

### Community 13 - "Community 13"
Cohesion: 0.12
Nodes (6): DistanceFieldPass, HUD(), Materials(), AnaglyphEffect(), CameraManager(), CaveViewer
...
Cohesion: 0.17
Nodes (17): CalibrationPoint, Props, Calibration, CaveSurface, classifyLiDAR(), normalizePlyColor(), normalizePlyIntensity(), ParsedCave (+9 more)
...
Cohesion: 0.11
Nodes (15): CaveLegs, Character3D, CYL_UP, ELEV_STOPS, EntranceMarkers, ManualConnection, StationLabels, Stations (+7 more)
...
Cohesion: 0.12
Nodes (11): de, en, fr, getBrowserLanguage(), getTranslation(), Language, languages, Translations (+3 more)

### Community 24 - "Community 24"
Cohesion: 0.14
Nodes (4): Cfg, EntrancePointMaterial, WallMaterial, LightingManager()
...
Cohesion: 0.16
Nodes (3): Frame, HelpPage, SelectionCommonPage
...
Cohesion: 0.14
Nodes (3): _getId(), SelectionPage, SelectionTreePage
...
Cohesion: 0.17
Nodes (3): EditPage, InfoPage, TracePanel
...
Cohesion: 0.2
Nodes (9): buildResult(), parseLox(), parsePlt(), parseSvx(), text, transferables, buffer, header (+1 more)
...
Cohesion: 0.18
Nodes (3): DepthMaterial, ExportGltf, ViewState
...
## Knowledge Gaps
- **251 isolated node(s):** `ImportMetaEnv`, `ImportMeta`, `CaveViewer3D`, `CaveViewerNextGen`, `WELCOME_CHANGELOG` (+246 more)
...
- **Why does `reconstructSurface()` connect `Community 0` to `Community 4`, `Community 30`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `parsePly()` connect `Community 17` to `Community 0`, `Community 42`, `Community 13`, `Community 5`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `draw()` connect `Community 5` to `Community 13`?**
