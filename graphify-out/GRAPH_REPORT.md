...
## Corpus Check
- 216 files · ~271,823 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1234 nodes · 1986 edges · 131 communities (60 shown, 71 thin omitted)
- Extraction: 70% EXTRACTED · 30% INFERRED · 0% AMBIGUOUS · INFERRED: 605 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f1135922`
...
## Communities (131 total, 71 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (25): intersectTrianglePlane(), equalArray(), getCanvas(), getMinMax(), getPaddedArrayBuffer(), getPaddedBufferSize(), GLTFExporter, GLTFLightExtension (+17 more)
...
Cohesion: 0.08
Nodes (13): _getId(), ScaleBar, EditPage, ExportPage, HelpPage, InfoPage, Page, RoutePanel (+5 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (9): LineSegments2, LineSegmentsGeometry, SurveyBox, CGeometry, Orb, TerrainMeshGeometry, Grid, Legs (+1 more)
...
Cohesion: 0.06
Nodes (7): ViewerOptions, AppState, draw(), LoadedFile, MemoizedStatusBadge, SelStation, SUPPORTED
...
Cohesion: 0.17
Nodes (3): Cfg, BarGeometry, WallMaterial
...
## Knowledge Gaps
- **106 isolated node(s):** `AppState`, `LoadedFile`, `SUPPORTED`, `MemoizedStatusBadge`, `Scrap` (+101 more)
...
- **Why does `reconstructSurface()` connect `Community 0` to `Community 2`, `Community 6`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `Stations` connect `Community 7` to `Community 1`, `Community 20`, `Community 9`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `parsePly()` connect `Community 22` to `Community 8`, `Community 0`, `Community 20`?**
